...
export type LinearWorkspaceSelection = 'all' | (string & {})
...
export type { GlobalSettings } from './global-settings-types'
...
// ─── Persistence shape ──────────────────────────────────────────────
export type { PersistedState } from './persisted-state-types'
