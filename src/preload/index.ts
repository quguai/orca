...
import { aoneApi } from './api/aone-bridge'
import {
  localTaskActivitiesApi,
  localTaskCommentsApi,
  localTaskLabelsApi,
  localTasksApi
} from './api/local-task-bridge'
...
const api = {
  ...
  gl: glApiBridge,
  aone: aoneApi,
  localTasks: localTasksApi,
  localTaskLabels: localTaskLabelsApi,
  localTaskComments: localTaskCommentsApi,
  localTaskActivities: localTaskActivitiesApi,
