...
import { getWorkspaceSourceCreateMetadata } from '../../../../shared/new-workspace/workspace-source'
...
export function useQuickSubmitPreparation(input: QuickSubmitPreparationInput) {
  ...
  const prepareQuickSubmit = useCallback(
    async (
      ...
      const linkedLinearIssue = linkedSourceCreateMetadata.linkedLinearIssue

      const linkedLinearIssueWorkspaceId = linkedSourceCreateMetadata.linkedLinearIssueWorkspaceId

      const linkedLinearIssueOrganizationUrlKey =
        linkedSourceCreateMetadata.linkedLinearIssueOrganizationUrlKey

      const linkedLocalTask = linkedSourceCreateMetadata.linkedLocalTask
