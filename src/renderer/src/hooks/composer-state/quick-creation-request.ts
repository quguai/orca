...
export type QuickCreationRequestInput = {
  ...
  linkedLinearIssueWorkspaceId: string | null | undefined
  linkedLinearIssueOrganizationUrlKey: string | null | undefined
  linkedLocalTask: string | null | undefined
...
export function buildQuickCreationRequest(
  ...
  return {
    ...
    ...(input.linkedLinearIssueOrganizationUrlKey !== undefined
      ...
      : {}),
    ...(input.linkedLocalTask != null ? { linkedLocalTask: input.linkedLocalTask } : {}),
