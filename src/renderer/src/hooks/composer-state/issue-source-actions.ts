...
import { useLocalTaskSourceActions } from './local-task-source-actions'
...
export function useIssueSourceActions(input: IssueSourceActionsInput) {
  ...
  const { handleSmartLocalTaskSelect } = useLocalTaskSourceActions(input)
