...
const DEFAULT_ON_STATUS_BAR_ITEMS: readonly (readonly [keyof PersistedUIState, StatusBarItem])[] = [
  ['_portsStatusBarDefaultAdded', 'ports'],
  ['_kimiStatusBarDefaultAdded', 'kimi'],
  ['_zaiStatusBarDefaultAdded', 'zai'],
...
function hydrateStatusBarItems(ui: PersistedUIState): StatusBarItem[] {
  ...
  const defaults = DEFAULT_ON_STATUS_BAR_ITEMS
