...
const ORDER: readonly TaskProvider[] = ['github', 'gitlab', 'linear', 'jira', 'aone', 'local']
...
function buildReadiness(
  ...
  const base: Record<TaskProvider, TaskProviderReadiness> = {
    ...
    aone: { connected: true, checking: false, visible: true },
    local: { connected: true, checking: false, visible: true }
  }
