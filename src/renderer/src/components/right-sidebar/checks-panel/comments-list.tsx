...
import { LoaderCircle, MessageSquare, Plus, SlidersHorizontal } from 'lucide-react'
...
import { CommentsListAiActions } from './comments-list-ai-actions'
import {
  getPRCommentsListResolutionFilterLabel,
  PRCommentResolutionFilterRow
} from './comment-resolution-filter'
import {
          ...
          <div className="-mr-1 ml-auto flex items-center gap-0.5">
            {canShowResolveWithAI && (
              <CommentsListAiActions
                ...
                visibleSelectableCount={visibleSelectableGroups.length}
                ...
                onSelectVisible={selectVisibleCommentsForAI}
          ...
          {displayMode === 'timeline' ? (
            ...
            <>
              ...
              <ResolvedCommentGroupsSection
                ...
                onOpenCommentContext={openCommentContext}
