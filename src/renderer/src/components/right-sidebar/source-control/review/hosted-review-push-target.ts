...
export function hasResolvableHostedReviewPushTargetLink(args: {
  ...
  // Why: only providers wired into the worktree push-target resolver belong
  // here; this mirrors getHostedReviewPushTargetLookup in the worktrees store.
  ...
  return (
    ...
    isPositiveHostedReviewNumber(args.linkedCodeMR)
  )
}
