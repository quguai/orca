...
function StatusBarInner({ floatingTerminalOpen }: StatusBarProps): React.JSX.Element | null {
  ...
  const { claude, codex, gemini, opencodeGo, kimi, zai, idealab, antigravity, minimax, grok } =
    rateLimits
  ...
  const isEmptyUsageState = isUsageEmptyState(
    { claude, codex, gemini, opencodeGo, kimi, zai, idealab, antigravity, minimax, grok },
    usageSettings
  )
  ...
  const rosterProviders = [
    ...
    showIdealab ? visibleIdealab : null,
