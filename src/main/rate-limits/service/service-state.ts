...
import {
  ...
  type IdealabUsageEnabledResolver,
  type ZaiApiKeyResolver,
...
export abstract class RateLimitServiceState {
  ...
  protected idealabUsageEnabledResolver: IdealabUsageEnabledResolver | null = null
  protected zaiApiKeyResolver: ZaiApiKeyResolver | null = null
