...
import {
  SkillLibraryOperations,
  installSkillLibraryOperationsContext
} from './skill-library-operations'
import {
...
export type StoreDomains = {
  ...
  skillLibrary: SkillLibraryOperations
...
export function installStoreDomainContexts(target: Store, domains: StoreDomains): void {
  ...
  installSkillLibraryOperationsContext(target, domains.skillLibrary)
...
export function createStoreDomains(runtime: StoreRuntimeState): StoreDomains {
  ...
  const skillLibrary = new SkillLibraryOperations(runtime, scheduling)
